...
local is_fosh_msg = msg.text:match("حشری") or msg.text:match("کونی") or msg.text:match("کیونی") or msg.text:match("کصده") or msg.text:match("تخمه") or msg.text:match("سگ") or msg.text:match("حروم زاده") or msg.text:match("حرومزاده") or msg.text:match("تمار") or msg.text:match("خار") or msg.text:match("کص") or msg.text:match("کس") or msg.text:match("کیر") or msg.text:match("کاندوم") or msg.text:match("شورت") or msg.text:match("کصکش") or msg.text:match("کون") or msg.text:match("بیشرف") or msg.text:match("بیناموس") or msg.text:match("بی ناموس") or msg.text:match("کثافت") or msg.text:match("کصافت") or msg.text:match("کسافت") or msg.text:match("اشغال") or msg.text:match("مفعول") or msg.text:match("فاک") or msg.text:match("fuck") or msg.text:match("سیک") or msg.text:match("سیکتیر") or msg.text:match("پات") or msg.text:match("چونی") or msg.text:match("گشاد") or msg.text:match("سولاخی") or msg.text:match("سکسی") or msg.text:match("سکس") or msg.text:match("صکص") or msg.text:match("سکص") or msg.text:match("صکس") or msg.text:match("صکصی") or msg.text:match("گو") or msg.text:match("عن") or msg.text:match("شاش") or msg.text:match("عنتر") or msg.text:match("گوریل") or msg.text:match("نفهم") or msg.text:match("عقب افتاده") or msg.text:match("عوضی") or msg.text:match("عوزی") or msg.text:match("پاره") or msg.text:match("ژنده") or msg.text:match("دزد") or msg.text:match("بی شرف") or msg.text:match("جاکش") or msg.text:match("پوفیوز") or msg.text:match("خایه") or msg.text:match("تخمک") or msg.text:match("پشم") or msg.text:match("ادرار") or msg.text:match("تاپاله") or msg.text:match("گوز") or msg.text:match("چوس") or msg.text:match("قرمساق") or msg.text:match("دیوث") or msg.text:match("دیوس") or msg.text:match("دیوص") or msg.text:match("لاشی") or msg.text:match("کــــــــــیر") or msg.text:match("کـیـــــــــــــــــــــــــــــــــــــــــــــــــــر") or msg.text:match("کــــــــــــــــــــــــــــــیر") or msg.text:match("کــــــــــیرر") or msg.text:match("لاشي") or msg.text:match("کوسی") or msg.text:match("جنده") or msg.text:match("کوس")
